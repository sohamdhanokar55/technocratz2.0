...
<html>
<head>
  <title>Registration Receipt - Bridge Building</title>
  <style>
...
<body>
  <h1>Registration Receipt - Bridge Building</h1>
  <div class="section">
    <div class="info-row">
    ...
    <div class="info-row">
      ...
      <span class="value">Bridge Building</span>
    </div>
    <div class="info-row">
  ...
  <div class="section">
    ...
    a.href = url;
    a.download = `bridge-building-receipt-${registrationData.id}.html`;
