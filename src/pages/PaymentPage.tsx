...
const PaymentPage = () => {
  ...
  const downloadReceipt = () => {
    if (!paymentRecord || !registrationPayload) return;
    ...
    const receiptData = {
      ...
      orderId: paymentRecord.order_id || paymentRecord.razorpay_order_id,
    ...
    a.href = url;
    a.download = `payment-receipt-${registrationId}.json`;
