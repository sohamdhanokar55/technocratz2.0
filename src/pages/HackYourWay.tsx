...
const HackYourWay = () => {
  ...
  const onSubmit = async (data: DuoFormData) => {
    try {
      ...
      // Transform the DuoFormData into participants array for backend
      const participants = [
        {
          name: data.leader.name,
          email: data.leader.email,
          contact: data.leader.contact,
          department: data.leader.branch,
          semester: data.leader.semester,
        },
        {
          name: data.members[0].name,
          email: data.members[0].email,
          contact: data.members[0].contact,
          department: data.members[0].branch,
          semester: data.members[0].semester,
        },
      ];
      ...
      const registration = {
        ...
        payload: {
          participants: participants, // Add transformed participants array
          institute: data.leader.institute,
          leader: data.leader, // Keep original structure for receipt
          members: data.members, // Keep original structure for receipt
        },
      ...
      const result = await startPayment({
        amountPaise,
        event: "Hack Your Way Competition",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24 pb-12 relative overflow-hidden">
      ...
      <SuccessModal
        ...
        eventName="Hack Your Way Competition"
