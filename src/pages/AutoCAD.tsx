...
<html>
<head>
  <title>Registration Receipt - AutoCAD Competition</title>
  <style>
...
<body>
  <h1>Registration Receipt - AutoCAD Competition</h1>
  <div class="section">
    <div class="info-row">
    ...
    <div class="info-row">
      ...
      <span class="value">AutoCAD Competition</span>
    </div>
    <div class="info-row">
  ...
  <div class="section">
    ...
    a.href = url;
    a.download = `autocad-receipt-${registrationData.id}.html`;
