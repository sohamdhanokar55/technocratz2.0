  ...
  const onSubmit = async (data: SingleParticipantFormData) => {
    try {
      ...
      const result = await startPayment({
        amountPaise,
        event: "Blind Typing Competition",
...
<html>
<head>
  <title>Registration Receipt - Blind Typing</title>
  <style>
...
<body>
  <h1>Registration Receipt - Blind Typing</h1>
  <div class="section">
    <div class="info-row">
    ...
    <div class="info-row">
      ...
      <span class="value">Blind Typing</span>
    </div>
    <div class="info-row">
  ...
  <div class="section">
    ...
    <table>
      ...
      <tr><td>Name</td><td>${registrationData.payload.name}</td></tr>
      <tr><td>Email</td><td>${registrationData.payload.email}</td></tr>
      <tr><td>Contact</td><td>${registrationData.payload.contact}</td></tr>
      <tr><td>Branch</td><td>${registrationData.payload.branch}</td></tr>
      <tr><td>Semester</td><td>${registrationData.payload.semester}</td></tr>
      <tr><td>Institute</td><td>${registrationData.payload.institute}</td></tr>
    </table>
  </div>
  ...
  <div class="section">
    ...
    a.href = url;
    a.download = `blind-typing-receipt-${registrationData.id}.html`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-300 bg-clip-text text-transparent mb-2">
            Blind Typing Registration
          </h1>
          <p className="text-lg text-gray-300 mb-4">Single participant registration</p>
      ...
      <Dialog open={isConfirmationOpen} onOpenChange={setIsConfirmationOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Your registration for Blind Typing has been confirmed.
            </DialogDescription>
          </DialogHeader>
          {registrationData && (
      ...
      <SuccessModal
        ...
        eventName="Blind Typing Competition"
