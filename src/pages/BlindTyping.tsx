...
const BlindTyping = () => {
  ...
  const onSubmit = async (data: SingleParticipantFormData) => {
    try {
      ...
      // Transform into participants array for backend (even for single participant)
      const participants = [
        {
          name: data.name,
          email: data.email,
      ...
      const registration = {
        ...
        event: "robo-race", // or "blind-typing", "autocad"
        participantsCount: totalParticipants,
        amountPaid: totalAmount,
        payload: {
          participants: participants, // For backend
          institute: data.institute,
          ...data, // Keep original data for receipt
        },
      ...
      const result = await startPayment({
        amountPaise,
        event: "Robo Race Competition", // Update for each event
