...
<html>
<head>
  <title>Registration Receipt - Robo Race</title>
  <style>
...
<body>
  <h1>Registration Receipt - Robo Race</h1>
  <div class="section">
    <div class="info-row">
    ...
    <div class="info-row">
      ...
      <span class="value">Robo Race</span>
    </div>
    <div class="info-row">
  ...
  <div class="section">
    ...
    a.href = url;
    a.download = `robo-race-receipt-${registrationData.id}.html`;
      ...
      <Dialog open={isConfirmationOpen} onOpenChange={setIsConfirmationOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Your registration for Robo Race has been confirmed.
            </DialogDescription>
          </DialogHeader>
          {registrationData && (
