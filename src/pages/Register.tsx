...
const Register = () => {
  ...
  const validateTeamLeader = () => {
    const { name, branch, year, college, contactNumber, alternateContactNumber } =
      formData.teamLeader;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-24 pb-12 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent mb-4">Loading Registration Form...</h1>
          <p className="text-gray-300">Please wait while we prepare your registration form.</p>
        </div>
      </div>
    );
  }
            ...
            {currentStep === 1 && (
              ...
              >
                ...
                <div className="space-y-6">
                  <div>
                    <Label htmlFor="leaderName" className="text-base font-semibold mb-2 block">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <Label htmlFor="leaderBranch" className="text-base font-semibold mb-2 block">
                    ...
                    <div>
                      <Label htmlFor="leaderYear" className="text-base font-semibold mb-2 block">
                  ...
                  <div>
                    <Label htmlFor="leaderCollege" className="text-base font-semibold mb-2 block">
                  ...
                  <div>
                    <Label htmlFor="leaderContact" className="text-base font-semibold mb-2 block">
                  ...
                  <div>
                    <Label htmlFor="leaderAltContact" className="text-base font-semibold mb-2 block">
                ...
                <div className="space-y-8">
                  {formData.teamMembers.length === 0 ? (
                    <div className="text-center py-8 text-gray-400">
                      <p>No additional team members required for this competition.</p>
                    </div>
                  ) : (
                  ...
                  <div className="bg-slate-700/30 rounded-xl p-8 border border-blue-500/20">
                    ...
                    <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-lg p-4">
                      <p className="text-sm text-yellow-300">
                        ...
                        to payment to complete your registration. You will receive
                    ...
                    <div className="space-y-3">
                      <div className="text-sm">
                        ...
                        <p className="text-gray-400 text-xs">
                          ...
                          {formData.teamLeader.year} | {formData.teamLeader.college}
                        </p>
                      </div>
                      {formData.teamMembers.map((member, index) => (
                        <div key={index} className="text-sm">
                          <p className="font-semibold text-blue-300">Member {index + 2}: {member.name}</p>
                          <p className="text-gray-400 text-xs">
