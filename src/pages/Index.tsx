...
const Index = () => {
  ...
  // Countdown timer for registration deadline (12-01-2026)
  useEffect(() => {
  ...
  const competitions = [
    ...
    },
    {
      ...
      rules: [
        " Length of the bridge must not exceed 60 cm.",
        " Breadth of the bridge must not exceed 10 cm",
        " Height of the bridge must be between 10 cm to 30 cm",
        " All dimensions will be measured from the model's outermost stick.",
        " There should not be extra struts added.",
        " Use only popsicles sticks for making truss and every part of the structure. The adhesive to be used should only be water soluble glue.",
        " If any of the conditions mentioned are violated, then the respective participants will be disqualified from the event.",
        " There is no limit on the number of models to be submitted. No restriction on the no of sticks to be used and the way they are to be arranged.",
        " These bridges will be checked for the maximum load carried and judged based on the maximum load. Taken by the bridge.",
        " In case of two or more models carrying same weight, judgment will be based on aesthetic appearance.",
      ],
      note: {
        "Maximum no of participants": "2",
        "Participation Fee": "Rs 100",
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <p className="text-gray-300 text-sm">
                    Analysis begins. Solutions take shape.
                    </p>
                  </motion.div>
                </div>
              </motion.div>
